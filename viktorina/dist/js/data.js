  ...
  questions: [
    {
      ...
      bg: 'img/pictures_new-1.jpg',
      bgMobile: 'img/pictures_new-1.jpg',
    },
{
      ...
      bg: 'img/pictures_new-2.jpg',
      bgMobile: 'img/pictures_new-2.jpg',
    },
{
      ...
      bg: 'img/pictures_new-3.jpg',
      bgMobile: 'img/pictures_new-3.jpg',
    },
{
      ...
      bg: 'img/pictures_new-4.jpg',
      bgMobile: 'img/pictures_new-4.jpg',
},
{
      ...
      bg: 'img/pictures_new-5.jpg',
      bgMobile: 'img/pictures_new-5.jpg',
    },
{
      ...
      bg: 'img/pictures_new-6.jpg',
      bgMobile: 'img/pictures_new-6.jpg',
    },
{
      ...
      bg: 'img/pictures_new-7.jpg',
      bgMobile: 'img/pictures_new-7.jpg',
    },
{
      ...
      bg: 'img/pictures_new-8.jpg',
      bgMobile: 'img/pictures_new-8.jpg',
    },
{
      ...
      bg: 'img/pictures_new-9.jpg',
      bgMobile: 'img/pictures_new-9.jpg',
    },
{
      ...
      bg: 'img/pictures_new-10.jpg',
      bgMobile: 'img/pictures_new-10.jpg',
    }
  ],
  resultTexts: [
    {
      ...
      html: "Ваши познания об Арктике пока еще скромны, но все равно это отличное начало! Уже сейчас читайте об истории промышленного освоения Заполярья в книге «<a onclick=\"sendGA('send','event','link_1');\" href='https://shelf.gazprom-neft.ru/press-center/news/61309/' target='_blank'>Первые в Арктике</a>» и пополните копилку своих знаний новыми интересными фактами!"
    },
    {
      from: 4,
      to: 6,
      title: 'Мишка на севере',
      html: "Кое-что об Арктике вы слышали, но в северную экспедицию вам пока рановато. Хотите прокачать свои знания? Начните с теоретической подготовки: каждое утро напевайте «Мы поедем, мы помчимся...» и почитайте «<a onclick=\"sendGA('send','event','link_2');\" href='https://shelf.gazprom-neft.ru/development/ecology/environmental_monitoring/Atlas_250319.pdf' target='_blank'>Экологический атлас Печорского моря</a>»"
    },
    {
      from: 7,
      to: 10,
      title: 'Северное сияние',
      html: "Ваш познания Арктики невероятны! Вами гордились бы Семен Челюскин и Отто Шмидт! Признавайтесь, вы наверняка провели прошлый отпуск в круизе на ледоколе или работаете на платформе «Приразломная»? Чтобы «арктическое» настроение и дальше не покидало вас, слушайте уникальные звуки Арктики – в проекте «<a onclick=\"sendGA('send','event','link_3');\" href='https://www.gazprom-neft.ru/press-center/special-projects/project/restarctica/?fbclid=IwAR34MCnHXiBnUk3uB5vpcpZ7MFZkNRo6GM0WsZWnm1CpSKkwvavQFKWOQRI' target='_blank'>Белый шум</a>», где собраны треск ломающегося льда, завывание арктического ветра, крики моржей, шум волн Баренцева моря, хлопанье крыльев арктических лебедей и другие звуки, которые можно услышать в окрестностях «Приразломной»"
    }
  ]
};
